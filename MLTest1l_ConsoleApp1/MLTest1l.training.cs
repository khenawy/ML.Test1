    ...
    public partial class MLTest1l
    {
        ...
        public static IEstimator<ITransformer> BuildPipeline(MLContext mlContext)
        {
            ...
            var pipeline = mlContext.Transforms.Conversion.MapValueToKey(outputColumnName:@"rate_code",inputColumnName:@"rate_code",addKeyValueAnnotationsAsText:false)      
                                    ...
                                    .Append(mlContext.Recommendation().Trainers.MatrixFactorization(new MatrixFactorizationTrainer.Options(){LabelColumnName=@"fare_amount",MatrixColumnIndexColumnName=@"trip_distance",MatrixRowIndexColumnName=@"rate_code",ApproximationRank=10,LearningRate=0.224123727989354,NumberOfIterations=133,Quiet=true}))      
